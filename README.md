...
2014 and 2015 were big years for disease outbreaks in California, especially among children, between a [measles outbreak](https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6406a5.htm) linked to visits to Disneyland theme parks and a [pertussis “epidemic”](https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6348a2.htm). At the same time, from the 2013 to 2015 school years, the percentage of California kindergartners with vaccine exemptions decreased (by about 21% overall); however, the rate of vaccine exemption has increased more than two-fold (211.59%) from 2000. That is, a large number of families have objected to vaccinating their children around the same time that outbreaks have occurred –– and especially in Northern California counties (as shown in the data visualization below). While the number of exemptions may have decreased during the years in question, **it would be valuable to investigate *why* there might be a geographic trend in vaccine refusal or exemptions**. For example, the higher exemption rates in one area suggest that there may be some sort of urban/rural divide, being higher in smaller and less urban counties. Additionally, the top 7 schools with the highest exemption rates from 2013 to the end of 2016 are from within these areas (i.e., Sacramento and Alameda counties are in the northern part of the state). These schools are not necessarily representative of all of Northern California, though they show how vaccination may be linked partially to values; each school is private, with 20 or fewer students, one school is online, one is religious and made the list twice, etc. After all, there has been an increase in [parental hesitancy](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6515949/) to vaccinate their children in recent years, with beliefs that vaccines could cause autism or overwhelm young immune systems. "Personal belief exemptions" are based on just that, *beliefs*, though California does allow them. 
